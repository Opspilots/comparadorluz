...
describe('signupSchema', () => {
  it('accepts valid signup', () => {
    const result = signupSchema.safeParse({ email: 'user@test.com', password: 'Secure1pass' })
    expect(result.success).toBe(true)
  })

  it('rejects short password', () => {
    const result = signupSchema.safeParse({ email: 'user@test.com', password: 'Ab1' })
    expect(result.success).toBe(false)
  })
  ...
  it('rejects password without number', () => {
    const result = signupSchema.safeParse({ email: 'user@test.com', password: 'SecurePass' })
    expect(result.success).toBe(false)
  })
})
