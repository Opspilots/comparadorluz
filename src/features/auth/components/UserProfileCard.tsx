...
export function UserProfileCard({ user }: UserProfileCardProps) {
    ...
    return (
        <div className="card" style={{ height: '100%', background: 'var(--surface)', border: '1px solid var(--color-border)' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '1rem', marginBottom: '1.5rem', paddingBottom: '1rem', borderBottom: '1px solid var(--color-border)' }}>
                <div style={{ padding: '0.75rem', background: 'var(--primary-light, #eff6ff)', color: 'var(--color-primary)', borderRadius: '0.75rem' }}>
                    <User size={24} />
                </div>
                <div>
