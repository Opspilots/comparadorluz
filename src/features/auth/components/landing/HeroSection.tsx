...
import { ArrowRight, Zap, TrendingUp, CheckCircle2, Clock } from 'lucide-react'
            ...
            >
                ...
                >
                    ...
                    <div className="flex items-center justify-between mb-4 pb-4" style={{ borderBottom: '1px solid rgba(255,255,255,0.06)' }}>
                        <div>
                            <div className="text-[11px] font-bold text-slate-400 tracking-[0.08em] uppercase mb-0.5">Comparativa activa</div>
                            <div className="text-[13px] font-semibold text-white">Aceros Bilbao S.L.</div>
                        </div>
                        <div className="text-right">
                            <div className="text-[10px] text-slate-500 mb-0.5">47.2 MWh/año</div>
                    ...
                    <div className="space-y-3 mb-4">
                        {rows.map((r, i) => (
                            <div key={i} className={`rounded-xl p-3 ${r.best ? 'border border-blue-500/20' : ''}`} style={{ background: r.best ? 'rgba(37,99,235,0.06)' : 'rgba(255,255,255,0.02)' }}>
                                <div className="flex items-center justify-between mb-1.5">
                                    <div className="flex items-center gap-2">
                                        {r.best && (
                                            <span className="text-[9px] font-bold text-blue-400 bg-blue-400/10 border border-blue-400/20 px-1.5 py-0.5 rounded">MEJOR</span>
                                        )}
                                ...
                                <div className="flex items-center gap-2">
                                    <div className="flex-1 h-1 rounded-full overflow-hidden" style={{ background: 'rgba(255,255,255,0.06)' }}>
                                        <div
                                            ...
                                            style={{
                                                width: r.w,
                                                background: r.best ? 'linear-gradient(90deg, #2563eb, #10b981)' : 'rgba(255,255,255,0.15)',
                                            }}
                                        />
                                    </div>
                                    <span className="text-[10px] text-slate-500 w-[52px] text-right">{r.price}/kWh</span>
                                </div>
                            </div>
                        ))}
                    </div>
                    ...
                    {/* Savings summary */}
                    <div className="flex items-center justify-between rounded-xl p-3" style={{ background: 'rgba(16,185,129,0.06)', border: '1px solid rgba(16,185,129,0.15)' }}>
                        <div className="flex items-center gap-2">
                        ...
                        <span className="text-[15px] font-extrabold text-emerald-400 tracking-tight">2.847€/año</span>
                    </div>
                </div>
        ...
        >
            ...
            <div className="absolute inset-0 overflow-hidden pointer-events-none">
                <div
                    ...
                    style={{ background: 'radial-gradient(circle, rgba(37,99,235,0.12) 0%, transparent 65%)', filter: 'blur(40px)' }}
                />
                <div
                ...
                <div
                    ...
                    style={{ background: 'radial-gradient(circle, rgba(16,185,129,0.06) 0%, transparent 65%)', filter: 'blur(50px)' }}
                />
            </div>
            ...
            {/* Split layout */}
            <div className="relative z-10 w-full max-w-[1300px] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center pt-24 pb-16 lg:py-0">
                {/* Left: text */}
                <div className="flex flex-col">
                    {/* Eyebrow */}
                    <div className="hero-badge inline-flex items-center gap-2.5 px-3.5 py-1.5 rounded-full mb-8 w-fit border border-white/[0.06] bg-white/[0.025]">
                        <div className="w-1.5 h-1.5 rounded-full bg-emerald-400 animate-pulse" />
                    ...
                    <div className="flex flex-col sm:flex-row gap-3 mb-10">
                        ...
                        <a
                            href="#como-funciona"
                            className="hero-cta-2 inline-flex items-center justify-center gap-2 px-7 py-3.5 rounded-xl bg-white/[0.04] text-slate-300 border border-white/[0.08] font-semibold text-[14px] hover:bg-white/[0.07] hover:text-white hover:border-white/[0.15] transition-all duration-300"
                        >
                    ...
                    {/* Trust row */}
                    <div className="hero-trust flex flex-wrap items-center gap-x-7 gap-y-2">
                        {[
                            { v: '200+', l: 'tarifas' },
                            ...
                            <div key={i} className="flex items-center gap-2">
                                ...
                                {i < 2 && <div className="w-px h-3 bg-white/10 hidden sm:block" />}
                            </div>
                        ))}
                    </div>
                </div>
