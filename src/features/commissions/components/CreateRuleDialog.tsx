...
import { Commissioner } from '@/shared/types'
...
export function CreateRuleDialog({ isOpen, onClose, onSuccess }: CreateRuleDialogProps) {
    ...
    const fetchFormData = async () => {
        ...
        if (commissionersData) setCommissioners(commissionersData)
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        const { error } = await supabase
            ...
            .insert({
                ...
                supplier_name: supplierName || null, // Convert empty string to null
                tariff_type: tariffType || null,       // Convert empty string to null
